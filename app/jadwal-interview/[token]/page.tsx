              ...
              <div className="flex flex-wrap gap-2">
                {isoList.map((iso) => (
                  <button
                    ...
                    className={`min-h-10 rounded-md border px-4 py-2 text-sm tabular-nums transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 ${
