...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      // min-w-0 wajib - ini flex item di sidebar-wrapper (flex row: sidebar +
      // konten), defaultnya "min-width: auto" - halaman berisi tabel lebar
      // (mis. Daily Closing "Hitung Stok Harian") jadi tidak bisa menyusut,
      // memaksa scroll horizontal di level browser bukan di dalam tabel.
      // Perbaikan 2026-09-14.
      className={cn(
